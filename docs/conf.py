...
MOCK_MODULES = ["sklearn", "sklearn.metrics", "tqdm", "tabulate", "numpy", "pycrfsuite"]
...
man_pages = [
    (master_doc, "sklearn-crfsuite", "sklearn-crfsuite Documentation", [author], 1)
]
